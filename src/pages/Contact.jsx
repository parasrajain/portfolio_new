  ...
  return (
    <div id="Contact" className="flex items-center flex-col gap-10 pb-10">
      ...
      <div >
        ...
        <div class="footer">
          <div class="footer-heading text-white font-sans font-bold text-4xl lg:text-6xl">Follow Me on</div>
...
{/* 
            ...
            <!-- /* From Uiverse.io by vinodjangid07 */ 
             /* From Uiverse.io by vinodjangid07 */ }
            <a href="https://github.com/parasrajain?tab=repositories" target="_blank">
              <button class="Btn3">
